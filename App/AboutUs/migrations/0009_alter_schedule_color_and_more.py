...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('AboutUs', '0008_alter_schedule_color'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='schedule',
            name='color',
            field=models.CharField(choices=[('bg-danger', 'red'), ('bg-warning', 'yellow'), ('bg-info', 'azure'), ('bg-success', 'green'), ('bg-primary', 'blue'), ('bg-secondary', 'gray'), ('bg-dark', 'dark gray')], default='bg-info', max_length=20),
        ),
        migrations.AlterField(
            model_name='schedule',
