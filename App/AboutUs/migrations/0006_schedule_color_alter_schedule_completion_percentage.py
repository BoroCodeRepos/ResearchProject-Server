...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('AboutUs', '0005_alter_schedule_completion_percentage'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='schedule',
            name='color',
            field=models.CharField(choices=[('red', 'bg-danger'), ('yellow', 'bg-warning'), ('azure', 'bg-info'), ('green', 'bg-success'), ('blue', 'bg-primary'), ('gray', 'bg-secondary'), ('dark gray', 'bg-dark')], default='red', max_length=20),
        ),
